...
def generar_numero_aleatorio_v1(valorMinimo,valorMaximo):
    '''
    Esta función se encarga de Generar un número aleatorio entre
    valorMinimo,valorMaximo, usando la funcion randInt del paquete standar
    random
    ...
    return: valor la opcion seleccionada por el usuario
    '''
    return random.randint(valorMinimo, valorMaximo)

def generar_numero_aleatorio_v2(valorMinimo,valorMaximo):
    '''
    Esta función se encarga de Generar un número aleatorio entre
    valorMinimo,valorMaximo, usando la funcion randrange del paquete standar
    random
